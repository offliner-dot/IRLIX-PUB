...
export const Bookmark = memo(({followUnfollwFavorites, isFavorites}) => {
    const bookmark = cn("bookmark");
    return (
        <div className={bookmark()} onClick={() => followUnfollwFavorites()} title="Избранное">
            <svg className={bookmark("svg", {active: isFavorites})} width="20" height="33"
                 viewBox="0 0 20 33" fill="none"
